...
namespace WebApplication2.Controllers
{
    public class ImagesController : ApiController
    {
        ...
        public async Task<string> POST()
        {
            ...
            //var productID = db.Products.Select(i => i.ProductID).ToArray().DefaultIfEmpty();
            ...
            for (int i = 0; i <= files.Count; i++)
            {
                ...
                if (postFile.ContentLength > 0)
                {
                    ...
                    image.ProductID = Convert.ToInt32(productID);
                    //image.ProductID = Convert.ToInt32(productID.ToString());
                    db.Images.Add(image);
